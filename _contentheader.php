<header class='content-header clearfix'>
            <div class="header-title"><h1><em>Safety Talk</em></h1></div>
            <div class="header-subtitle"><h6><span>Psychedelic Country Surf</span><span>from Oalkand, California</span></h6></div>
              <div id='links'>
